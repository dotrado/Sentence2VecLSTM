...
inputFile = open("./data/movieDataset/movieData.csv")
outputFile = open("./data/movieDataset/label.data", "w")
...
for line in csv.reader(inputFile, skipinitialspace=True):
    ...
    with open("./data/movieDataset/" + line[0] + ".text", "w") as text:
    ...
    with open("./data//movieDataset/" + line[0] + ".vec", "w") as vec:
        for d in testDocs:
